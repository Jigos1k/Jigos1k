...
<p align="left">- 🚀 **Фронтенд-разработчик** с фокусом на современные технологии  <br>- 🌱 **Изучаю:** React, Java (Spring), Vue 3  <br>- 💡 **Могу помочь с:**  <br>  - Дизайном интерфейсов (Figma/Adobe XD)  <br>  - Оптимизацией Vue-приложений  <br>  - Интеграцией API (REST/GraphQL)  <br>- ⚡ **Увлечения:** Геймдев, нейросети, 3D-моделирование</p>
